    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">List Customer

                <router-link to="/add-customer"  tag="button">New</router-link>
            ...
            <div class="table-responsive">
              <table class="table table-hover">
                ...
                <tbody>
                <tr v-for="Customer in list = searchValue.length < 1 ? listCustomer : searchResults " :key="Customer.id">
                  ...
                  <td>
                    ...
                    <router-link :to="`/edit-customer/${Customer.id}`"  tag="button">Edit</router-link>
                    <button
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      // this.checklogin();
      await axios
          .get('/admin/user/customer?page='+this.paginate.current_page, token)
          .then(response => {
    ...
    searchHandler()  {
      if (this.searchValue !== "") {
        ...
        //   headers: {'Authorization': `Bearer ${localStorage.getItem("token")}`}
        // }
        // await  axios.get('user/customer?search='+this.searchValue, token).then((response)=> {
        //   // console.log(response.data)
