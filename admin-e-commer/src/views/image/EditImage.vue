          ...
          <div class="card card-body">
            ...
            <form class="form-horizontal m-t-30">
              <div class="form-group">
                ...
                <input class="form-control" type="text" value="image.name" v-model="image.name" />
              </div>
              <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      console.log(id)
      await axios.get('/images/' + id, token).then((response)=> {
    ...
    async handleEdit() {
      ...
      if(this.message.length<=0){
        ...
        await axios.put('images/' + id, imageData, token).then((response) => {
          console.log(response.data.data)
