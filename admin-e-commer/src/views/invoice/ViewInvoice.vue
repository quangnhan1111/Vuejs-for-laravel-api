          ...
          <div class="card card-body">
            ...
            <form class="form-horizontal m-t-30">
              <div class="form-group">
                ...
                <input class="form-control" type="text"  name="title" value="nameCustomerOrder" v-model="nameCustomerOrder" readOnly/>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td>Total For this Invoice: {{ totalPriceForThisInvoice }}.00$</td>
                    </tr>
                    </tbody>
                  </table>
                </div>
